...
function ContractReviewPageContent() {
  ...
  async function handleAnalyze() {
    ...
    try {
      // Use standard analysis - streaming enabled to prevent timeouts
          ...
          >
            ...
            {showAnalysisComparison && analysisCompareResult ? (
              ...
              <div className="space-y-4">
                ...
                <div className="mt-4 p-4 bg-[#0B1220] border border-[#38BDF8]/30 rounded-lg">
                  ...
                  <textarea
                    ...
                    placeholder="Add notes for the approver... (e.g., key concerns, context, or specific areas to review)"
                    className="w-full h-24 px-3 py-2 bg-[#151F2E] border border-white/10 rounded-lg text-white text-sm placeholder-[#64748B] focus:outline-none focus:border-[#38BDF8]/50 resize-none"
                  />
                  <p className="text-[10px] text-[#64748B] mt-1">
