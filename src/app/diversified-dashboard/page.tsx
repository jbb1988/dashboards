        ...
        <div className="p-8 max-w-[1800px] mx-auto">
          ...
          {loading ? (
            ...
            <>
              ...
              {/* Unified Filter & Context Bar */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.3 }}
                className="flex items-center gap-3 mb-6 min-h-[44px]"
              >
                {/* LEFT SECTION: Global Filters */}
                <div className="flex items-center gap-2">
                  {/* View Toggle - only on table tab */}
                  {activeTab === 'table' && (
                ...
                {/* CENTER SECTION: Insights Sub-Navigation (only on insights tab) */}
                {activeTab === 'insights' && (
                  <div className="flex items-center gap-1.5 px-3 py-1 bg-[#0F172A] rounded-lg border border-white/[0.04]">
                ...
                {/* RIGHT SECTION: Mode Controls & Actions (Insights only) */}
                {activeTab === 'insights' && (
                  <div className="flex items-center gap-2">
                    {/* R12/YoY Toggle */}
                    ...
                    {/* Year Selectors (conditional on YoY mode) */}
                    {insightsMode === 'yoy' && (
                ...
                {/* Reset All - non-Insights tabs with active filters */}
                {(selectedYears.length > 0 || selectedMonths.length > 0 || selectedClass || selectedCustomer) && activeTab !== 'insights' && (
                  <button
