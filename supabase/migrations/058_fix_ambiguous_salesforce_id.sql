-- Fix: "column reference 'salesforce_id' is ambiguous" error
-- Problem: Function returns TABLE(salesforce_id text) but RETURNING clause
--          references contracts.salesforce_id, causing ambiguity
-- Solution: Rename the output column to sf_id to avoid conflict
